...
const logos = [
  ...
  { name: 'Figma', svg: 'M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 0 3.019-1.355 3.019-3.019s-1.355-3.019-3.019-3.019h-3.117V7.51zm0 8.943h-4.588c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zM4.147 11.962c0 1.665 1.354 3.019 3.019 3.019h3.117V8.943H7.166c-1.665 0-3.019 1.354-3.019 3.019zm4.537 7.019c0 2.476-2.014 4.49-4.49 4.49S-.296 21.457-.296 18.981s2.014-4.49 4.49-4.49h4.49v4.49zm-1.471 0c0-1.665-1.354-3.019-3.019-3.019s-3.019 1.354-3.019 3.019 1.354 3.019 3.019 3.019 3.019-1.354 3.019-3.019zM8.147 8.981H3.559c-2.476 0-4.49-2.014-4.49-4.49S1.083 0 3.559 0h4.588v8.981zM.54 4.49c0 1.665 1.354 3.019 3.019 3.019h3.117V1.471H3.559C1.894 1.471.54 2.826.54 4.491zm14.96 8.943c0-2.476-2.014-4.49-4.49-4.49s-4.49 2.014-4.49 4.49 2.014 4.49 4.49 4.49 4.49-2.014 4.49-4.49zm-7.51 0c0-1.665 1.354-3.019 3.019-3.019s3.019 1.354 3.019 3.019-1.354 3.019-3.019 3.019-3.019-1.354-3.019-3.019z', fillRule: 'evenodd' as const },
  { name: 'Notion', svg: 'M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L18.28 2.16c-.42-.326-.98-.7-2.055-.607L3.293 2.552c-.466.046-.56.28-.373.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.84-.046.933-.56.933-1.167V6.354c0-.606-.233-.933-.746-.886l-15.177.886c-.56.047-.747.327-.747.934zm14.337.746c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.746 0-.933-.234-1.494-.933l-4.577-7.186v6.952l1.448.327s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.14c-.093-.514.28-.886.747-.933zM1.936 1.035l13.31-.98c1.634-.14 2.054-.047 3.082.7l4.249 2.986c.7.513.933.653.933 1.213v16.378c0 1.026-.373 1.634-1.68 1.726l-15.458.934c-.98.046-1.448-.094-1.962-.747l-3.129-4.06c-.56-.747-.793-1.306-.793-1.96V2.667c0-.84.374-1.54 1.448-1.632z', fillRule: 'evenodd' as const },
