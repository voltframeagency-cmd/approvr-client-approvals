  ...
  return (
    <section className="py-24 border-t border-b border-border/40 relative overflow-hidden bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="absolute left-0 top-0 bottom-0 w-40 bg-gradient-to-r from-background to-transparent z-10 backdrop-blur-sm" />
          <div className="absolute right-0 top-0 bottom-0 w-40 bg-gradient-to-l from-background to-transparent z-10 backdrop-blur-sm" />
