...
const plans = [
  {
    ...
    period: '/mo',
    description: 'For solo creatives and small teams who want clients to approve — not ghost.',
    features: [
      '10 active projects',
      'Client approval portal with your branding',
      'Timestamped approval receipts',
  ...
  },
  {
    ...
    period: '/mo',
    description: 'For agencies running high-volume client work who need total control and zero friction.',
    features: [
    ...
    icon: Building2,
    badge: 'Best Value',
    note: 'White-glove migration assistance included',
  },
];
